 ...
 */
define ('PDF_HEADER_LOGO', 'stanford-healthcre.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Stanford What-Matters-Most Letter Directive');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "NEW HEADER TEXT");
